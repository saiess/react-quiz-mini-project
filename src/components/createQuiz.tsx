...
const CreateQuiz = ({ quizCreatedData, setQuizCreatedData, fetchQuestions }: ChildProps) => {
    ...
    return (
        <section className='w-full flex justify-between gap-4'>
            <select className='w-2/5 rounded-lg px-3 py-2 mt-1 mb-1 text-sm text-white focus:border-cyan-700 focus:ring-cyan-500'
            ...
            <Button style={'border-cyan-600'}  text={'Create'} onClick={fetchQuestions}
            />
        </section>
    );
};
